#ifndef IM_FX_ACCOUNT_H
#define IM_FX_ACCOUNT_H
#include <glib.h>
#include "account.h"
 ...
 *
 * @param account The IMAccount struct.
 ...
 */
fetion_account *fetion_account_create(IMAccount *account, const gchar *no,
